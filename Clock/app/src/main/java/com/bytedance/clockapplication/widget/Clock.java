...
public class Clock extends View {
    ...
    private void drawHoursValues(Canvas canvas) {
        // Default Color:
        // - hoursValuesColor
        TextPaint paint = (TextPaint) new TextPaint();
        ...
        for (int i = 0; i < FULL_ANGLE; i += 30 /* Step */) {
            ...
            int stopX = (int) (mCenterX + (rEnd - 100) * Math.cos(Math.toRadians(60-i)));
            int stopY = (int) (mCenterX - (rEnd - 100) * Math.sin(Math.toRadians(60-i)));
            canvas.drawText(Integer.toString(i/30+1), stopX, stopY, paint);
        }
